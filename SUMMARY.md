...
## How To Play <a id="how-to-play-1"></a>

* [Getting started](how-to-play-1/getting-started.md)
* [MetaMask Wallet Setup](how-to-play-1/metamask-wallet-setup.md)
...
* [Calculating How Many ORE To Add Liquidity](how-to-play-1/calculating-how-many-ore-to-add-liquidity.md)
...
* [ORE Token](tokenomics/ore-token.md)
* [Pre-Sale](tokenomics/pre-sale.md)
