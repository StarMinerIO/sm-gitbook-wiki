...
MetaMask is also compatible with the Brave browser.
...
3. View your secret seed phrase and write it down in a secure location.
...
Never give your seed phrase out to anyone. This can be used similar to your password to access your account.
 ...
 StarMiner developers and moderators will never ask for your seed phrase and password.
{% endhint %}
...
StarMiner and ORE token requires your wallet to be set to the Binance Smart Chain Mainnet.
...
Congratulations, you are now ready to receive BNB in your address and purchase ORE.
